...
Я пишу на **Go** и **Python**, активно применяю их для создания веб-приложений и инструментов анализа данных. В свободное время работаю над pet-проектами, которые решают интересные прикладные задачи: от прогнозирования событий до систем раннего предупреждения.
